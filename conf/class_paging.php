...
class Paging {
    ...
    function navHalaman($halaman_aktif, $jmlhalaman) {
        ...
        if ($halaman_aktif > 1) {
            ...
            $link_halaman .= "<a href=$_SERVER[PHP_SELF]?r=$_GET[r]&page=$_GET[page]&halaman=1><< First</a> | 
						<a href=$_SERVER[PHP_SELF]?r=$_GET[r]&page=$_GET[page]&halaman=$prev>< Prev</a> | ";
        } else {
        ...
        for ($i = $halaman_aktif - 2; $i < $halaman_aktif; $i++) {
            if ($i < 1)
                continue;
            $angka .= "<a href=$_SERVER[PHP_SELF]?r=$_GET[r]&page=$_GET[page]&halaman=$i>$i</a> | ";
        }
        ...
        $angka .= ($halaman_aktif + 2 < $jmlhalaman ? " ... | <a href=$_SERVER[PHP_SELF]?r=$_GET[r]&page=$_GET[page]&halaman=$jmlhalaman>$jmlhalaman</a> | " : " ");
        ...
        if ($halaman_aktif < $jmlhalaman) {
            ...
            $link_halaman .= " <a href=$_SERVER[PHP_SELF]?r=$_GET[r]&page=$_GET[page]&halaman=$next>Next ></a> | 
						 <a href=$_SERVER[PHP_SELF]?r=$_GET[r]&page=$_GET[page]&halaman=$jmlhalaman>Last >></a> ";
        } else {
