...
if (isset($_POST["save"])) {
    ...
    $params = $_POST['master'];
//
//    $execute = mysql_query("insert into tb_unit SET name = '" . mysql_real_escape_string(trim(htmlentities($_POST['nama_unit']))) . "'");
...
//    die();
    ...
    if (!empty($execute1)) {
        header('Location: ../../index.php?r=detailunit&page=view&status=sukses');
    } else {
        header('Location: ../../index.php?r=detailunit&page=view&status=gagal2');
    }
} else {
