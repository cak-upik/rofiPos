<?php
			...
			else
			{
					...
					else
					{
						...
						$execute=mysql_query("insert into tb_pegawai (nama, alamat, tempat, tgl_lahir, no_telp, email, username, password, id_jabatan, foto) 
                                                    values (
                                                            ...
                                                            '". mysql_real_escape_string(trim(htmlentities($image_name))) . "') ");
