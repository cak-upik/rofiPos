...
if (isset($_GET['page'])) {
    ...
    if ($page == 'view') {
        ...
        <button onClick="document.location = 'index.php?r=lap_penjualan&page=laporanhari';" class="btn btn-info"><i class="icon-file icon-white"></i> Laporan Hari Ini</button>
        ...
        <div class="btn-group">
            <a class="btn dropdown-toggle" data-toggle="dropdown" href="#"><i class="icon-money"></i>
                Laba
                <span class="caret"></span>
            </a>                 
            <ul class="dropdown-menu">
                <li><a href="index.php?r=lap_penjualan&page=laba"><i class="icon-align-left"></i> Laba Penjualan</a></li>
                <!--<li><a href="index.php?r=lap_penjualan&page=unit"><i class="icon-align-left"></i> Laba Unit</a></li>-->
            </ul>
        </div>
        <p></p>
        ...
        <table class="table table-bordered table-striped table-highlight">
            ...
            <tbody>
                ...
                $query = mysql_query("SELECT p.* ,  c.`name` as customer , l.`name` as leasing, u.`name` as unit , 
                                    ...
                                    order by p.id_penjualan DESC LIMIT $posisi,$batas");
                ...
                <table class="table table-bordered table-highlight table-striped">
                    <thead>
                        <tr>
                            ...
                            <th>No. Mesin</th>
                            <th>Tahun</th>
                            <th>HargaOTR(Rupiah)</th>
                            <th>Uang Muka(Rupiah)</th>
                            <th>Diskon(Rupiah)</th>
                            <th>Jumlah(Rupiah)</th>
                        </tr>
                    </thead>
...
//                        die();
                        ...
                        if ($total > 0) {
                            ...
                            while ($row = mysql_fetch_array($query)) {
                                echo"<tr>
                                    ...
                                    <td>$row[no_mesin]</td>
                                    <td>$row[tahun]</td>
                                    <td style = 'text-align:right;'>" . rupiah1($row['hargaotr']) . "</td>
                                    <td style = 'text-align:right;'>" . rupiah1($row['uang_muka']) . "</td>
                                    <td style = 'text-align:right;'>" . rupiah1($row['diskon']) . "</td>
                                    <td style = 'text-align:right;'>" . rupiah1($row['jml']) . "</td>
                                    </tr>";
                                $no++;
                            }
                            ?>
            ...
            <form name="form" class="form-horizontal" method="POST" action="index.php?r=lap_penjualan&page=laba">
                ...
                ?>    
                <input class="btn btn-primary" name="search" type="submit" value="Submit">
            </form>
            <legend></legend>
            ...
            if (isset($_POST['search'])) {
                $q .= "where substr(p.tanggal,6,2)= '$month' and substr(p.tanggal,1,4) = '$year' group by p.id_penjualan order by p.id_penjualan desc Limit $posisi, $batas";
            } else {
                $q .= "where substr(p.tanggal,6,2)= '$dateMonth' and substr(p.tanggal,1,4) = '$dateYear' group by p.id_penjualan order by p.id_penjualan desc Limit $posisi, $batas";
            }
            ...
            <script type="text/javascript">
                        ...
                        $(document).ready(function() {
                            chart1 = new Highcharts.Chart({
                                ...
                                title: {
                                    text: 'Laba Penjualan Unit Per Tanggal '
                                },
                                xAxis: {
                                    categories: ['Tanggal']
                                },
...
//            $laba = mysql_fetch_array($query);
                ...
                <script type="text/javascript">
                                ...
                                $(document).ready(function() {
                                    chart1 = new Highcharts.Chart({
                                        ...
                                        title: {
                                            text: 'Laba Per Bulan 2014',
                                            x: -20 //center
                                        },
                                        xAxis: {
                                            categories: ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec', 'Jan 2015']
                                        },
                                        plotOptions: {
                                            line: {
                                                dataLabels: {
                                        ...
                                        series: [{
                                                name: 'Laba Kotor',
                                                data: [17724325, 16734460, 16251825, 10779870, 12026095, 16750595, 15432505, 18579865, 10128505, 18313050, 17724325, 16734460]
                                            }]
                                    });
                                });</script>
                <div class="row">
            ...
            <?php } elseif ($_POST['thn_filter'] === '2015') { ?>
...
//            $year = $_POST['thn_filter'];
        ...
        //                            },
        //                                    title: {
        //                                    text: 'Laba Penjualan Per Tahun '
        //                                    },
        <?php
        $sql = " SELECT YEAR(p.tanggal) as SalesYear,
p.tanggal as SalesMonth,
SUM(dp.average) AS TotalSales
...
INNER JOIN ref_customer rc ON rc.id_customer = p.id_customer";
        ...
        if (isset($_POST['search'])) {
            $sql .= " where YEAR(p.tanggal) = '$year' 
GROUP BY YEAR(p.tanggal), MONTH(p.tanggal)
ORDER BY YEAR(p.tanggal), MONTH(p.tanggal)";
        } else {
...
ORDER BY YEAR(p.tanggal), MONTH(p.tanggal)";
        ...
        <?php } elseif ($page == 'unit') {
            ?>
            <script src="module/lap_penjualan/jquery.dataTables.js"></script>
            <script src="module/lap_penjualan/jquery.dataTables.min.js"></script>
            <script src="module/lap_penjualan/jquery.js"></script>
            <!--            <form name="form" target="_blank" method="POST" action="index.php?r=lap_penjualan&page=unit">
                            <fieldset>
                                <legend><i class="icon icon-filter"></i> Filter</legend>
                                <div class="well">
                                    <div class="row-fluid">
                                        <div class="span12">
                                            <div class="control-group" >
                                                ...
                                                <div class="controls">
                                                    <select name="unit" id="unit" class="input-medium">
                                                        <option value="0">-Pilih-</option>
            <?php
            $selectUnit = mysql_query("select * from tb_unit");
            ...
            <center><h2>Grafik Penjualan Unit</h2></center>
            <?php
            $q = "SELECT u.id, du.id_unit, count(`u`.`id`) AS `jumlah`
                                    FROM penjualan p  
                                    INNER JOIN detail_penjualan dp ON dp.id_penjualan = p.id_penjualan 
                                    INNER JOIN tb_detail_unit du ON du.id_detail_unit = dp.id_detail_unit
                                    INNER JOIN tb_unit u ON dp.id_unit = u.id
                    ...
                    if ($total > 0) {
                        ...
                        while ($result = mysql_fetch_array($query)) {
                            echo"<tr>
                                ...
                                <td>$result[tahun]</td>
                                <td style='text-align:right;'>" . rupiah1($result['hargaotr']) . "</td>
                                <td style='text-align:right;'>" . rupiah1($result['uang_muka']) . "</td>
                                <td style='text-align:right;'>" . rupiah1($result['diskon']) . "</td>
                                <td style='text-align:right;'>" . rupiah1($result['jml']) . "</td>
                             </tr>";
                            $no++;
                        }
                    } else {
